...
SELECT pg_catalog.setval('item_id_seq', 23326, true);
...
SELECT pg_catalog.setval('linea_plan_id_seq', 125574, true);
...
SELECT pg_catalog.setval('plan_compras_id_seq', 585, true);
...
CREATE TABLE usuario (
    codigousuario character varying(25) NOT NULL,
    nombreusuario character varying(50) NOT NULL,
    claveusuario character varying(150) NOT NULL,
    estaactivo boolean DEFAULT true NOT NULL,
...
SELECT pg_catalog.setval('usuario_id_seq', 185, true);
...
ALTER TABLE fuente_financiamiento ALTER COLUMN id SET DEFAULT nextval('fuente_financiamiento_id_seq'::regclass);
...
ALTER TABLE nivel ALTER COLUMN id SET DEFAULT nextval('nivel_id_seq'::regclass);
...
ALTER TABLE origen_financiamiento ALTER COLUMN id SET DEFAULT nextval('origen_financiamiento_id_seq'::regclass);
...
Anclas Plásticas de 1/4" x 2"	t	f	0.06	f	\N	368	42	156	238
Comentarios a la Ley de Notariado/ Editorial Jurídica	t	f	12.00	f	\N	377	43	294	238
Tubos de abasto, P/ Inodoros , Forrados plástico 18" x  1/4 “x  3/4"	t	f	3.19	f	\N	379	45	188	238
Cuaderno #12 de espiral de tres materias con logo de "Minerva"	t	f	2.64	f	\N	366	47	90	238
...
D.S. Penicilina 10 UNITS, 50 discos,	t	f	48.00	f	\N	368	41	386	239
...
12.00	125569	585	239	43	2
72.00	125570	585	238	49	2
24.66	125571	585	238	54	2
16.21	125572	585	238	31	12
2.94	125573	585	238	26	9
60.00	125574	585	238	65	9
\.
...
\N	0.00	f	\N	f	\N	f	\N	\N	4	9	585	4	2	2	0001
\.
...
COPY usuario (codigousuario, nombreusuario, claveusuario, estaactivo, email, id_perfil_usuario, id, id_unidad_solicitante) FROM stdin;
\.
...
--
-- Name: usuario_codigousuario_key; Type: CONSTRAINT; Schema: public; Owner: admin; Tablespace: 
--

ALTER TABLE ONLY usuario
    ADD CONSTRAINT usuario_codigousuario_key UNIQUE (codigousuario);
...
--
-- Name: fuente_financiamiento_id_origen_financiamiento_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY fuente_financiamiento
    ADD CONSTRAINT fuente_financiamiento_id_origen_financiamiento_fkey FOREIGN KEY (id_origen_financiamiento) REFERENCES origen_financiamiento(id) ON UPDATE CASCADE ON DELETE RESTRICT;
